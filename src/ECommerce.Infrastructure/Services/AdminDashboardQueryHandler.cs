...
public sealed class AdminDashboardQueryHandler : IRequestHandler<GetDashboardStatsQuery, Result<DashboardStatsResponse>>
{
    ...
    public async Task<Result<DashboardStatsResponse>> Handle(GetDashboardStatsQuery command, CancellationToken cancellationToken)
    {
