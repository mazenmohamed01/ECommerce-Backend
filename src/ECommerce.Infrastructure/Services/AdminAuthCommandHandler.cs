...
/// </summary>
internal sealed class AdminAuthCommandHandler : IRequestHandler<AdminLoginCommand, Result<AuthResponse>>
{
    ...
    /// <inheritdoc/>
    public async Task<Result<AuthResponse>> Handle(AdminLoginCommand command, CancellationToken cancellationToken)
    {
