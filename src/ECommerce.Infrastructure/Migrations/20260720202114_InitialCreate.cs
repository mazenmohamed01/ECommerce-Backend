        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCountry = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false, defaultValue: "Saudi Arabia"),
                    ...
                    PaymentGateway = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_order_discount_amount_non_negative", "\"DiscountAmount\" >= 0");
                    table.CheckConstraint("ck_order_shipping_cost_non_negative", "\"ShippingCost\" >= 0");
                    table.CheckConstraint("ck_order_sub_total_non_negative", "\"SubTotal\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_product_price_non_negative", "\"Price\" >= 0");
                    table.CheckConstraint("ck_product_stock_non_negative", "\"QuantityInStock\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_order_item_unit_price_non_negative", "\"UnitPrice\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "uix_product_sku",
                table: "Products",
                column: "Sku",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "uix_product_slug",
                table: "Products",
                column: "Slug",
                unique: true);
