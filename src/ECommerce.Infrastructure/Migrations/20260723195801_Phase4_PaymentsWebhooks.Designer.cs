...
namespace ECommerce.Infrastructure.Migrations
{
    ...
    [Migration("20260723195801_Phase4_PaymentsWebhooks")]
    partial class Phase4_PaymentsWebhooks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("OrderStatus", "PaymentMethod", "CreatedAt")
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.OutboundWebhookEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.OutboundWebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.ProcessedWebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MoyasarEventId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("Products", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_product_reserved_stock_valid", "\"ReservedStock\" >= 0 AND \"ReservedStock\" <= \"QuantityInStock\"");
            ...
            modelBuilder.Entity("ECommerce.Domain.Entities.OutboundWebhookEvent", b =>
                {
                    b.HasOne("ECommerce.Domain.Entities.OutboundWebhookEndpoint", "Endpoint")
                        .WithMany()
