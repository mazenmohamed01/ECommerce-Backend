...
/// <summary>
/// Validates <see cref="UploadProductImageRequest"/> before Cloudinary upload is attempted.
/// File signature (magic bytes) is checked in the service layer after this validator passes.
/// </summary>
public sealed class UploadProductImageRequestValidator : AbstractValidator<UploadProductImageRequest>
{
